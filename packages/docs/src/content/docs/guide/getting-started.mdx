...
- [Concepts](/machina.js/guide/concepts/) — the mental model behind states, inputs, and transitions
- [createFsm](/machina.js/guide/fsm/) — full API reference including hierarchical states, deferred input, and events
- [createBehavioralFsm](/machina.js/guide/behavioral-fsm/) — define behavior once, apply it to many independent client objects
- [Examples](/machina.js/examples/overview/) — real-world patterns you can steal
- [Tools](/machina.js/tools/machina-inspect/) — static analysis and ESLint integration for catching structural bugs at dev time
