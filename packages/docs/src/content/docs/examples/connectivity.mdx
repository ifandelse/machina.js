...
<LinkCard
    title="Run the Connectivity Monitor"
    href="/machina.js/demos/connectivity/"
    target="_blank"
/>
...
[examples/connectivity/](https://github.com/ifandelse/machina.js/tree/machina-v6/examples/connectivity)
