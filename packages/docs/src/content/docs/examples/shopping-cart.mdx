...
<LinkCard title="Run the Shopping Cart" href="/machina.js/demos/shopping-cart/" target="_blank" />
...
[examples/shopping-cart/](https://github.com/ifandelse/machina.js/tree/machina-v6/examples/shopping-cart)
