...
<LinkCard title="Run the Dungeon Critters" href="/demos/dungeon-critters/" target="_blank" />
...
[examples/dungeon-critters/](https://github.com/ifandelse/machina.js/tree/master/examples/dungeon-critters)
