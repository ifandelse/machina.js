...
<LinkCard title="Run the React Example" href="/machina.js/demos/with-react/" target="_blank" />
...
[examples/with-react/](https://github.com/ifandelse/machina.js/tree/machina-v6/examples/with-react)
