...
The machina documentation site, built with [Astro Starlight](https://starlight.astro.build/). Serves at `https://machina-js.org`.
...
| `tools/`     | Companion tool docs (machina-inspect, ESLint plugin) |
...
Example apps are not built as part of `astro build` — they're assembled during CI only.
